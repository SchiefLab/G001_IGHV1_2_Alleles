...
```{r composite-genotype-mrna-cdr3-plot, fig.pos = 'htbp', fig.width=11, fig.height=10, fig.cap='Composite Genotype-mRNA-HCDR3-Usage-Plot', warnings=FALSE} 
...
g_top = plot_grid(NULL,g_genotype, NULL, g_allele, NULL, g_imbalance, NULL, nrow=1, align='h', axis='tb', labels=c('A','','B','','C',''),
               rel_widths = c(0.5,7.8,0.5,6.2,0.5,9,0.75))
g_ll = plot_grid(plot_grid(NULL, p_mRNA_freq, labels=c('D',''), rel_widths = c(0.1,2)),
                 plot_grid(NULL, g_barcodes_a, NULL,NULL, g_barcodes_b, 
                           rel_widths = c(0.14,1,0.005,0.095,1), nrow=1,
                           align='h', axis='tb', labels=c('F','','','G','')), 
                 rel_heights = c(12,8),
                 nrow=2) %>%
       plot_grid(NULL, rel_widths = c(1,0.05))
g_lr = plot_grid(plot_grid(NULL, p_cdr3_freq, labels=c('E'), rel_widths = c(0.1,2)),
                 plot_grid(NULL,g_barcodes_c, NULL,NULL, g_barcodes_d, 
                           rel_widths = c(0.14,1,0.05,0.05,1), nrow=1,
                           align='h', axis='tb', labels=c('H','','','I','')), 
                 rel_heights = c(12,8),
                 nrow=2)  %>%
       plot_grid(NULL, rel_widths = c(1,0.05))
...
if( file.exists('../data/ratio_tab_boot_vacc_cdr3.RData') ) {
  ...
  ratio_tab_boot_vacc_cdr3 = data.frame(Group = c('Homozygote','Heterozygote'),
                   ...
                   lci = c(ratio.boot.vacc.ci[1], tt.hetero.vacc.cdr3$conf.int[1]),
                   uci = c(ratio.boot.vacc.cdr3.ci[2], tt.hetero.vacc.cdr3$conf.int[2]),
                   pval = c(ratio.boot.vacc.cdr3.pval, sprintf('%0.4f', tt.hetero.vacc.cdr3$p.value)))
...
\blandscape
```{r quasipoisson-genotype-plot-comb4, fig.pos = 'htbp', fig.height=7, fig.width=8, fig.scap="Allele model estimates by genotype", fig.cap= "Allele model estimates by genotype.", warning=F}
...
```{r comb-ratio-plot2, fig.width=7, fig.height=8.5, fig.scap='Ratio estimates', fig.cap='Ratio estimates', warning=FALSE}
...
\blandscape
```{r naive-rep-vrc01-resp-correlations-v2-with-week11, fig.pos = 'htbp', fig.height=7, fig.width=8, fig.cap='Naive vs. VRC01 response correlations', warning=FALSE}
...
\blandscape
```{r naive-rep-vrc01-resp-correlations-v3-with-week11, fig.pos = 'htbp', fig.height=7, fig.width=8, fig.cap='Naive vs. VRC01 response correlations', warning=FALSE}
...
\blandscape
```{r qaicc-with-quasipoisson-fit-plot, fig.pos = 'htbp', fig.scap="Quasipoisson fit plot", fig.cap="Quasipoisson fit plot", warning=F}
